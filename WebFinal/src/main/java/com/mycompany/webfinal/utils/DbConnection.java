 ...
 */
package com.mycompany.webfinal.utils;
import java.sql.*;
...
public class DbConnection {
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/usuario?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
